<template>
  <el-dialog title="添加网址" :visible="visible" width="800px" append-to-body @close="handleClose">
...
<script>
import {editWeb} from "@/api/website";
...
export default {
  ...
  mounted() {
    this.form = {
      ...
      websiteName: this.obj.websiteName,
      companyName: this.obj.companyName,
      websiteUrl: this.obj.websiteUrl,
      websiteDescribe: this.obj.websiteDescribe,
    }
    this.previewImageUrl = handleFile(this.obj.picture)
  },
  data(){
    return {
